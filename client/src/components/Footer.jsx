    ...
    <Container as='footer' role='contentinfo' maxW='7xl'>
      <Stack
        ...
        <Stack spacing={{ base: '6', md: '8' }} align='start'>
          <Flex alignItems='center'>
            <Icon as={GiTechnoHeart} h={10} w={10} color='blue.400' />
          ...
          <Stack direction='row' spacing='8'>
            <Stack spacing='4' minW='36' flex='1'>
              ...
              <Stack spacing='3' shouldWrapChildren>
                ...
                <Button variant='link'>Common Q&A</Button>
            ...
            <Stack spacing='4' minW='36' flex='1'>
              ...
              <Stack spacing='3' shouldWrapChildren>
                <Button variant='link'>Order entry</Button>
      ...
      <Stack pt='8' pb='12' justify='space-between' direction={{ base: 'column-reverse', md: 'row' }} align='center'>
        <Text fontSize='sm' color='subtle'>
          &copy; {new Date().getFullYear()} eBuy, Inc. All rights reserved.
        </Text>
