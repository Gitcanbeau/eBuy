...
const AddNewProduct = () => {
  ...
  const createNewProduct = () => {
    dispatch(uploadProduct({ name, image, category, description, stock, price, productIsNew }));
  };
  ...
  return (
    <Tr>
      ...
      <Td>
        <VStack>
          <Button variant='outline' w='160px' colorScheme='blue' onClick={() => createNewProduct()}>
            <MdDriveFolderUpload />
